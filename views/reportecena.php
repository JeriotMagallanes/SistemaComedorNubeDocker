        ...
        <div  class=" card card-outline card-info">
            <div class="card-header">
                <div class="row col-md-12">
                    <div class="col-md-6">
                        <p class="card-title" style="font-size: 22px">Reporte de Cena de Estudiantes</p>
                    </div>
            ...
            <div class="card-body table-responsive">
                <table class="table text-center" id="tablaReporteCena">
                    <thead>
                        <tr>
                    ...
                    <tbody class="table" id="tablaReporteCenaListar">
...
<script src="js/reportecena.js"></script>
