        ...
        <div  class=" card card-outline card-info">
            <div class="card-header">
                <div class="row col-md-12">
                    <div class="col-md-6">
                        <p class="card-title" style="font-size: 22px">Ingresar Fecha de Llegada Productos</p>
                    </div>
            ...
            <div class="card-body table-responsive">
                <table class="table text-center" id="tablallegadaProductos">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center ">Marcar Llegada</th>
                        </tr>
                    </thead>
                    <tbody class="table" id="tablallegadaProductosListar">
