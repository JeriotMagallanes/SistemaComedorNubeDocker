...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2024 a las 20:08:38
...
CREATE TABLE `detalle_bitacora` (
  ...
  `enc_sanidadAntes` int(11) NOT NULL,
  `enc_QAAntes` int(11) NOT NULL,
  `enc_almacenAntes` int(11) NOT NULL,
  `fk_jefe_fundoAntes` int(11) NOT NULL,
  `nom_fundoAntes` int(11) NOT NULL,
  `fk_loteAntes` int(11) NOT NULL,
  `fk_sloteAntes` int(11) NOT NULL,
  `fk_cultivoAntes` int(11) NOT NULL,
  `fk_variedadAntes` int(11) NOT NULL,
  `nrReservaAntes` int(11) NOT NULL,
  `nrInstructivoAntes` int(11) NOT NULL,
  `pepAntes` int(11) NOT NULL,
  `etapa_cultivoAntes` int(11) NOT NULL,
  `enc_sanidadDespues` int(11) NOT NULL,
  `enc_QADespues` int(11) NOT NULL,
  `enc_almacenDespues` int(11) NOT NULL,
  `fk_jefe_fundoDespues` int(11) NOT NULL,
  `nom_fundoDespues` int(11) NOT NULL,
  `fk_loteDespues` int(11) NOT NULL,
  `fk_sloteDespues` int(11) NOT NULL,
  `fk_cultivoDespues` int(11) NOT NULL,
  `fk_variedadDespues` int(11) NOT NULL,
  `nrReservaDespues` int(11) NOT NULL,
  `nrInstructivoDespues` int(11) NOT NULL,
  `pepDespues` int(11) NOT NULL,
  `etapa_cultivoDespues` int(11) NOT NULL,
...
(138, 12, 10, 'L', 1, '1', '1', '1', '1', '1', '1', '1', 70),
(139, 15, 23, 'KG', 1, '1', '1', '1', '1', '1', '1', '1', 70),
(140, 12, 10, 'L', 2, '2', '2', '2', '2', '2', '2', '2', 70),
(141, 10, 10, 'L', 1, '1', '1', '1', '1', '1', '1', '1', 71),
(142, 12, 10, 'L', 2, '2', '2', '2', '2', '2', '2', '2', 71),
...
INSERT INTO `registro_actividad_reporte` (`id_ARreporte`, `ARfecha`, `ARnombres`, `ARcodigo_reporte`, `ARaccion`, `ARobservacion`) VALUES
(1, '2024-01-31 09:43:26', 'Administrador Administrador', 37, 'Eliminar', 'ninguna'),
(2, '2024-01-31 10:32:05', 'Administrador Administrador', 39, 'Eliminar', 'Observacion'),
(3, '2024-01-31 10:56:14', 'b', 0, 'Modificar', '36'),
(4, '2024-01-31 11:00:49', 'sssssd', 12, 'Modificar', 'dsssdsds'),
(5, '2024-01-31 11:02:12', 'Administrador Administrador', 36, 'Modificar', 'ninguna'),
(6, '2024-02-01 08:57:57', 'Administrador Administrador', 41, 'Modificar', 'Error de confusion con el jefe de fundo'),
(7, '2024-02-01 09:12:09', 'Administrador Administrador', 42, 'Modificar', 'Error de digitacion de jefe de fundo'),
(8, '2024-02-01 11:10:27', 'Administrador Administrador', 25, 'Modificar', 'Error de digitacion de jefe de fundo'),
(9, '2024-02-01 11:22:43', 'Administrador Administrador', 40, 'Modificar', 'Error de digitacion de jefe de fundo'),
(10, '2024-02-01 22:35:01', 'Administrador Administrador', 49, 'Modificar', 'Error digitacion jefe de fundo'),
(11, '2024-02-02 06:54:50', 'Administrador Administrador', 51, 'Modificar', 'Error al seleccionar jefe de fundo'),
(12, '2024-02-02 19:50:01', 'Administrador Administrador', 51, 'Modificar', 'error de digitacion de lote'),
(13, '2024-02-02 19:53:03', 'Administrador Administrador', 51, 'Modificar', 'Error de digitacion de jefe de fundo'),
(14, '2024-02-03 07:56:20', 'Administrador Administrador', 51, 'Modificar', 'quiero'),
(15, '2024-02-03 07:56:52', 'Administrador Administrador', 51, 'Modificar', 'x'),
(16, '2024-02-03 09:30:14', 'Administrador Administrador', 47, 'Modificar', 'ninguna'),
(17, '2024-02-03 13:17:10', 'Administrador Administrador', 59, 'Eliminar', '2024-02-03'),
(18, '2024-02-05 19:42:18', 'Administrador Administrador', 75, 'Eliminar', 'k'),
(19, '2024-02-06 12:39:03', 'Administrador Administrador', 76, 'Modificar', 'zzzzz'),
(20, '2024-02-06 12:42:35', 'Administrador Administrador', 69, 'Modificar', 'AAAAAAAAA'),
(21, '2024-02-06 12:44:57', 'Administrador Administrador', 73, 'Modificar', 'AAAAAAAAAAA'),
(22, '2024-02-06 12:47:14', 'Administrador Administrador', 70, 'Modificar', 'eeeeeeeee'),
(23, '2024-02-06 13:22:19', 'Administrador Administrador', 72, 'Modificar', 'tttt'),
(24, '2024-02-06 13:24:26', 'Administrador Administrador', 69, 'Modificar', 'eee'),
(25, '2024-02-06 13:39:36', 'Administrador Administrador', 69, 'Modificar', 'eeee'),
(26, '2024-02-06 13:41:22', 'Administrador Administrador', 69, 'Modificar', 'rrrrrrr'),
(27, '2024-02-06 13:52:28', 'Administrador Administrador', 70, 'Modificar', 'sssss');
...
(47, '2024-01-31 13:41:13', 'Tarde', 'b', 'b', 'b', 19, NULL, 1, 13, 69, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, 0, 0, 1),
(48, '2024-02-01 13:41:40', 'Tarde', 'a', 'a', 'a', 17, NULL, 1, 5, 61, 1, 1, 'Aprobado', 'Aprobado', 'Aprobado', NULL, 3, 0, 0, 1),
(49, '2024-02-01 13:41:57', 'Tarde', 'n', 'n', 'n', 29, NULL, 10, 47, 108, 10, 22, 'Aprobado', 'Aprobado', 'Aprobado', NULL, 3, 0, 0, 1),
...
(69, '2024-02-06 06:25:00', 'Mañana', 'zzzz', 'eeeeeeeeeee', 'zzzzzzzzzzzzz', 21, NULL, 3, 25, 81, 1, 4, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 4, 788, 887, 1),
(70, '2024-02-06 06:25:15', 'Mañana', 'p', 'p', 'p', 18, NULL, 1, 10, 66, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 4, 8, 8, 2),
(71, '2024-02-06 06:25:28', 'Mañana', 'ñ', 'ñ', 'ñ', 16, NULL, 1, 1, 57, 1, 1, 'No Aprobado', 'Aprobado', 'No Aprobado', NULL, 3, 4, 4, 1),
(72, '2024-02-06 06:25:42', 'Mañana', 'h', 'h', 'h', 20, NULL, 2, 18, 74, 1, 2, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 4, 6, 6, 1),
(73, '2024-02-06 06:26:00', 'Mañana', 'AAAAAAAA', 'eAAAAAAAAAA', 'eAAAAAAAAAAAA', 16, NULL, 1, 1, 57, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, 3, 3, 2),
(74, '2024-02-06 06:28:57', 'Mañana', 'q', 'q', 'q', 16, NULL, 1, 1, 57, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, 8, 8, 1),
(76, '2024-02-06 19:22:18', 'Mañana', '1', '1', '1', 29, NULL, 12, 49, 110, 10, 21, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 5, 1, 1, 1);
...
ALTER TABLE `detalle_bitacora`
  ...
  ADD KEY `enc_sanidadAntes` (`enc_sanidadAntes`,`enc_QAAntes`,`enc_almacenAntes`,`fk_jefe_fundoAntes`,`nom_fundoAntes`,`fk_loteAntes`,`fk_sloteAntes`,`fk_cultivoAntes`,`fk_variedadAntes`,`nrReservaAntes`,`nrInstructivoAntes`,`pepAntes`,`etapa_cultivoAntes`,`enc_sanidadDespues`,`enc_QADespues`,`enc_almacenDespues`,`fk_jefe_fundoDespues`,`nom_fundoDespues`,`fk_loteDespues`,`fk_sloteDespues`,`fk_cultivoDespues`,`fk_variedadDespues`,`nrReservaDespues`,`nrInstructivoDespues`,`pepDespues`,`etapa_cultivoDespues`),
  ADD KEY `nom_fundoAntes` (`nom_fundoAntes`),
  ADD KEY `fk_reporte` (`fk_reporte`);
...
--
ALTER TABLE `registro_actividad_reporte`
  MODIFY `id_ARreporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `detalle_bitacora`
  ADD CONSTRAINT `detalle_bitacora_ibfk_1` FOREIGN KEY (`nom_fundoAntes`) REFERENCES `fundo` (`id_fundo`) ON DELETE CASCADE ON UPDATE CASCADE;
