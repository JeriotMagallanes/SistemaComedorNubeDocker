...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-02-2024 a las 20:05:31
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_actualizarReservaInstructivo` (IN `_reserva` INT, IN `_instructivo` INT, IN `_id_reporte` INT)   UPDATE reporte SET
reporte.nrReserva=_reserva,
reporte.nrInstructivo=_instructivo
WHERE reporte.id_reporte=_id_reporte$$
...
lote.nombre_lote,sub_lote._slote_nombre, cultivo.nombre_cultivo,variedad.nombre_variedad,
reporte.nrReserva,reporte.nrInstructivo,pep.nombre_pep,etapa_cultivo.nombreEcultivo
FROM reporte
INNER JOIN usuarios on reporte.fk_jefe_fundo=usuarios.idusuario
...
reporte.nrReserva,reporte.nrInstructivo,reporte.etapa_cultivo,etapa_cultivo.nombreEcultivo,reporte.fecha_llegada
FROM reporte
...
reporte.fecha_llegada=_fechaLlegada
WHERE reporte.id_reporte=_idreporte$$
...
reporte.nrReserva,reporte.nrInstructivo,pep.nombre_pep,etapa_cultivo.nombreEcultivo,reporte.fecha_llegada
FROM reporte 
INNER JOIN usuarios ON reporte.fk_jefe_fundo= usuarios.idusuario 
INNER JOIN lote ON reporte.fk_lote=lote.id_lote 
INNER JOIN sub_lote ON reporte.fk_slote= sub_lote.id_sub_lote 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_reporte_registro` (IN `_fecha_hora` DATETIME, IN `_turno` VARCHAR(15), IN `_enc_sanidad` VARCHAR(50), IN `_enc_QA` VARCHAR(50), IN `_enc_almacen` VARCHAR(50), IN `_fundo` INT, IN `_nonfundo` INT(30), IN `_lote` INT, IN `_slote` INT, IN `_cultivo` INT, IN `_variedad` INT, IN `_pep` INT, IN `_etcultivo` INT, IN `_fechallegada` DATE)   INSERT INTO `reporte`( `fecha_hora`, `turno`, `enc_sanidad`, `enc_QA`, `enc_almacen`, `fk_jefe_fundo`, `nom_fundo`, `fk_lote`, `fk_slote`, `fk_cultivo`, `fk_variedad`, `aprob_jefefundo`, `aprob_jefesanidad`,reporte.aprob_jefeCalidad,reporte.pep,reporte.etapa_cultivo,reporte.fecha_llegada) VALUES (NOW(),_turno,_enc_sanidad,_enc_QA,_enc_almacen,_fundo,_nonfundo,_lote,_slote,_cultivo,_variedad,'No Aprobado','No Aprobado','No Aprobado',_pep,_etcultivo,_fechallegada)$$
...
(155, 12, 21, 'L', 0, '1', '1', '1', '11', '1', '1', '1', 77),
(156, 14, 18, 'L', 23, '23', '2354', '25', '54', '56', '48', '25', 77),
(157, 12, 22, 'L', 8, '8', '8', '88', '8', '8', '8', '8', 105),
(158, 10, 23, 'KG', 1, '1', '1', '1', '11', '1', '1', 'q', 105),
(159, 12, 23, 'KG', 333333, '3', '3', '3', '3', '3', '3', '3', 105),
(160, 11, 24, 'KG', 4, '4', '4', '4', '4', '4', '4', '4', 105),
(161, 11, 19, 'KG', 1, '1', '1', '1', '1', '1', '11', '1', 106);
...
(13, '2024-02-08 13:16:01', 'Administrador Administrador', 154, 'Eliminar', 'NO HUBO'),
(14, '2024-02-12 09:14:24', 'Administrador Administrador', 162, 'Eliminar', 'NO HAY OIDIUM'),
(15, '2024-02-12 09:18:27', 'Administrador Administrador', 106, 'Eliminar', 'No hay');
...
(51, '2024-02-08 12:54:41', 'Administrador Administrador', 77, 'Modificar', 'Modificacion', 'enc_almacen=Jose<br>nrInstructivo=5263<br>etapa_cultivo=Cosecha<br>', 'enc_almacen=Victor<br>nrInstructivo=8547<br>etapa_cultivo=Mantenimiento<br>', NULL),
(52, '2024-02-08 13:07:19', 'Administrador Administrador', 77, 'Modificar', 'ERROR DE DIGITACION', 'nrReserva=1452<br>pep=Fumigación<br>', 'nrReserva=11485<br>pep=Foliar<br>', NULL),
(53, '2024-02-10 09:43:43', 'Administrador Administrador', 99, 'Modificar', 's', '', '', NULL),
(54, '2024-02-10 10:02:14', 'Administrador Administrador', 99, 'Modificar', 'e', '', '', NULL),
(55, '2024-02-10 10:02:26', 'Administrador Administrador', 99, 'Modificar', 'e', '', '', NULL),
(56, '2024-02-10 10:03:28', 'Administrador Administrador', 99, 'Modificar', 'w', '', '', NULL),
(57, '2024-02-12 13:56:59', 'Administrador Administrador', 72, 'Modificar', 'a', 'enc_sanidad=h<br>enc_QA=h<br>enc_almacen=h<br>fk_jefe_fundo=Gary Trujillo<br>nom_fundo=SAN HILARION<br>fk_lote=1204-7A<br>fk_slote=7A<br>fk_variedad=Sweet Globe<br>', 'enc_sanidad=q<br>enc_QA=q<br>enc_almacen=q<br>fk_jefe_fundo=Silverio Ccoyori<br>nom_fundo=SANTA MARGARITA<br>fk_lote=1117-6.1<br>fk_slote=6.1<br>fk_variedad=Red Globe<br>', NULL);
...
CREATE TABLE `reporte` (
  ...
  `pep` int(11) NOT NULL,
  `nrReserva` int(11) DEFAULT NULL,
  `nrInstructivo` int(11) DEFAULT NULL,
...
(50, '2024-02-01 22:24:35', 'Noche', 'b', 'b', 'b', 16, NULL, 1, 1, 57, 1, 1, 'Aprobado', 'Aprobado', 'Aprobado', NULL, 3, NULL, NULL, 1),
(51, '2024-02-02 06:48:57', 'Mañana', '1', '1', '1', 17, NULL, 1, 5, 61, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 4, NULL, NULL, 2),
(52, '2024-02-02 06:49:15', 'Mañana', 'b', 'b', 'b', 26, NULL, 6, 41, 100, 6, 19, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-03', 3, NULL, NULL, 1),
(53, '2024-02-02 06:49:42', 'Mañana', 'p', 'p', 'p', 27, NULL, 6, 42, 101, 6, 19, 'No Aprobado', 'Aprobado', 'No Aprobado', NULL, 3, NULL, NULL, 1),
(54, '2024-02-02 06:57:41', 'Mañana', 'aaa', 'a', 'a', 18, NULL, 1, 9, 65, 1, 1, 'No Aprobado', 'Aprobado', 'No Aprobado', NULL, 3, NULL, NULL, 1),
(55, '2024-02-02 11:38:50', 'Mañana', 'a', 'a', 'a', 25, NULL, 6, 43, 102, 6, 19, 'Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, NULL, NULL, 1),
(56, '2024-02-02 11:39:11', 'Mañana', 'b', 'bb', 'b', 17, NULL, 1, 5, 61, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, NULL, NULL, 1),
(57, '2024-02-02 11:40:14', 'Mañana', 't', 't', 't', 21, NULL, 3, 24, 80, 1, 2, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, NULL, NULL, 1),
(58, '2024-02-02 14:04:26', 'Tarde', '1', '1', '1', 27, NULL, 6, 42, 101, 6, 19, 'No Aprobado', 'No Aprobado', 'No Aprobado', NULL, 3, NULL, NULL, 2),
(60, '2024-02-03 08:12:41', 'Mañana', 'Martin', 'Fabian', 'Jesus', 21, NULL, 3, 24, 80, 1, 2, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-02', 3, NULL, NULL, 2),
(61, '2024-02-03 08:15:12', 'Mañana', 'a', 'a', 'a', 16, NULL, 1, 1, 57, 1, 1, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-03', 3, NULL, NULL, 2),
(62, '2024-02-03 08:15:37', 'Mañana', 'b', 'bb', 'bb', 16, NULL, 1, 1, 57, 1, 1, 'Aprobado', 'Aprobado', 'Aprobado', '2024-01-29', 3, NULL, NULL, 1),
(63, '2024-02-03 08:16:04', 'Mañana', 'h', 'h', 'h', 24, NULL, 5, 37, 94, 4, 18, 'Aprobado', 'Aprobado', 'Aprobado', NULL, 3, NULL, NULL, 2),
(64, '2024-02-03 08:16:28', 'Mañana', 'm', 'm', 'm', 20, NULL, 2, 22, 78, 1, 2, 'Aprobado', 'Aprobado', 'Aprobado', NULL, 4, NULL, NULL, 1),
(65, '2024-02-03 10:23:11', 'Mañana', 'Martin', 'Miguel', 'Jose', 22, NULL, 4, 31, 87, 5, 16, 'No Aprobado', 'Aprobado', 'No Aprobado', NULL, 5, NULL, NULL, 2),
(66, '2024-02-05 06:23:25', 'Mañana', 'aAaA', 'a', 'a', 19, NULL, 1, 12, 68, 1, 1, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-06', 3, NULL, NULL, 2),
(67, '2024-02-05 06:24:13', 'Mañana', 'b', 'b', 'b', 25, NULL, 6, 40, 99, 6, 19, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-05', 4, NULL, NULL, 2),
(72, '2024-02-12 12:53:13', 'Mañana', 'q', 'q', 'q', 19, NULL, 1, 13, 69, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', '0000-00-00', 4, NULL, NULL, 1),
(73, '2024-02-12 12:53:13', 'Mañana', 'AAAAAAAA', 'eAAAAAAAAAA', 'eAAAAAAAAAAAA', 16, NULL, 1, 1, 57, 1, 1, 'Aprobado', 'Aprobado', 'No Aprobado', NULL, 3, 12, 21, 2),
(74, '2024-02-12 12:53:13', 'Mañana', 'q', 'q', 'q', 16, NULL, 1, 1, 57, 1, 1, 'Aprobado', 'Aprobado', 'No Aprobado', NULL, 3, 12, 34, 1),
(76, '2024-02-12 12:53:13', 'Mañana', '1', '1', '1', 29, NULL, 10, 47, 108, 10, 22, 'Aprobado', 'Aprobado', 'No Aprobado', NULL, 5, NULL, NULL, 1),
(77, '2024-02-12 12:53:13', 'Tarde', 'Martin', 'Jaime', 'Victor', 20, NULL, 2, 16, 72, 1, 2, 'No Aprobado', 'Aprobado', 'Aprobado', NULL, 3, NULL, NULL, 2),
(99, '2024-02-10 09:02:50', 'Mañana', 'a', 'a', 'a', 16, NULL, 1, 1, 57, 1, 1, 'Aprobado', 'Aprobado', 'No Aprobado', '2024-02-06', 3, NULL, NULL, 1),
(100, '2024-02-10 10:18:07', 'Mañana', 'm', 'm', 'm', 16, NULL, 1, 1, 57, 1, 1, 'No Aprobado', 'Aprobado', 'No Aprobado', '2024-02-21', 4, 14, 87, 1),
(101, '2024-02-10 10:18:24', 'Mañana', 'p', 'p', 'p', 20, NULL, 2, 16, 72, 1, 2, 'No Aprobado', 'No Aprobado', 'No Aprobado', '2024-02-20', 4, 78, 87, 1),
(102, '2024-02-10 10:18:45', 'Mañana', 'l', 'l', 'l', 27, NULL, 6, 42, 101, 6, 19, 'No Aprobado', 'Aprobado', 'No Aprobado', '2024-02-14', 4, 12, 32, 1),
(103, '2024-02-10 10:19:00', 'Mañana', 'p', 'p', 'p', 21, NULL, 3, 24, 80, 1, 2, 'No Aprobado', 'No Aprobado', 'No Aprobado', '2024-02-27', 5, 10, 72, 1),
(104, '2024-02-10 13:05:36', 'a', 'a', 'a', 'a', 22, NULL, 4, 31, 87, 5, 16, 'No Aprobado', 'No Aprobado', 'No Aprobado', '0000-00-00', 5, 10, 14, 2),
(105, '2024-02-12 07:54:42', 'Noche', 'lunes', '1', '1', 17, NULL, 1, 7, 63, 1, 1, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-14', 3, 1540, 5874, 1),
(106, '2024-02-12 09:04:58', 'Mañana', 'Jose', 'Eduardo', 'Martin', 20, NULL, 2, 16, 72, 1, 2, 'Aprobado', 'Aprobado', 'Aprobado', '2024-02-22', 4, 7841, 1542, 1),
(107, '2024-02-12 12:35:22', 'Mañana', 'w', 'w', 'w', 17, NULL, 1, 6, 62, 1, 1, 'No Aprobado', 'No Aprobado', 'No Aprobado', '2024-02-01', 3, 111, 111, 1);
...
(16, 'Amadeo', 'Acuña', 'aacuña', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-02-02', NULL, 'J', 'A', '20240126021435.jpg', 'uva1s@beta.com', NULL, 53),
(17, 'Roberto', 'Bernales', 'rbernales', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-02-02', NULL, 'J', 'A', '20240125071905.jpg', 'uva1s@beta.com', NULL, 53),
(18, 'Roque', 'Sifuentes', 'rsifuentes', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-25', NULL, 'J', 'A', '20240125071919.jpg', 'uva1s@beta.com', NULL, 53),
(19, 'Silverio', 'Ccoyori', 'sccoyori', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 53),
(20, 'Gary', 'Trujillo', 'gtrujillo', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 53),
(21, 'Miguel', 'Deunis', 'mdeunis', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 53),
(22, 'Fernando', 'Cabrera', 'fcabrera', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 53),
...
(25, 'Karina', 'Torres', 'ktorres', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 54),
(26, 'Eder', 'Razabal', 'erazabal', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '20240125071954.jpg', 'uva1s@beta.com', NULL, 54),
(27, 'Ricardo', 'Velarde', 'rvelarde', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 54),
(28, 'Miguel', 'Vallardares', 'mvallardares', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'J', 'A', '20240126041603.jpg', 'uva1s@beta.com', NULL, 55),
...
(53, 'Nelson', 'Barillas', 'nbarillas', '$2y$10$QEcOCoBpjdEZ3KAmPIKaBuSc7sHWpSczJy3U1cCBhgNMM1zOXMuvS', '2024-02-08', NULL, 'T', 'A', '', 'uva1s@beta.com', NULL, NULL),
(54, 'Antonio ', 'Linares', 'alinares', '$2y$10$apnwwdVLVkHoJgB/VcH1EuUCWnxMv9crlXnS2PfqaT8y/cz9n36CK', '2024-02-08', NULL, 'T', 'A', '', 'uva1s@beta.com', NULL, NULL),
(55, 'Pedro', 'Ecos', 'pecos', '$2y$10$cAm93LN65MnGJOesJkbPqeluLz1P6eSg1KZ8LVTaKUCJC8kCZb52m', '2024-02-08', NULL, 'T', 'A', '', 'uva1s@beta.com', NULL, NULL),
(56, 'Jorge ', 'Barrios', 'jbarrios', '$2y$10$/pzwsZ1ZZDPY4gAncxSM5OpVBnzmgEAfZoVR47sRIb6mGVG7dJyO6', '2024-02-08', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 55),
(57, 'Edison ', 'Zamora', 'ezamora', '$2y$10$8giwUwsBeFtyE3.hjLehHecN698dejQVyRW8SHEdQlSqr.ckQcBay', '2024-02-08', NULL, 'J', 'A', '', 'uva1s@beta.com', NULL, 55);
...
--
ALTER TABLE `detalle_reporte`
  MODIFY `id_detallereporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
...
--
ALTER TABLE `registro_actividad_detalle`
  MODIFY `id_RDreporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `registro_actividad_reporte`
--
ALTER TABLE `registro_actividad_reporte`
  MODIFY `id_ARreporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT de la tabla `reporte`
--
ALTER TABLE `reporte`
  MODIFY `id_reporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
