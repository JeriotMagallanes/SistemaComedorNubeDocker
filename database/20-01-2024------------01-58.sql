...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2024 a las 19:47:12
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_fundo_filtrar_fecha_reportes` (IN `_inicial` DATETIME, IN `_final` DATETIME)   SELECT reporte.id_reporte, reporte.fecha_hora, reporte.turno,
...
(5, '2024-01-20 08:29:41', 'Mañana', 'aaa', 'aaa', 'aaa', 17, 'Santa Margarita', 5, 61, 1, 1, 'No Aprobado', 'No Aprobado'),
(6, '2024-01-19 08:29:41', 'Mañana', 'bbb', 'bbb', 'bbb', 25, 'DOS MARIAS', 40, 99, 6, 19, 'No Aprobado', 'No Aprobado'),
(7, '2024-01-20 08:29:41', 'Mañana', 'ccc', 'ccc', 'ccc', 29, 'SAN ISIDRO LABRADOR', 46, 107, 10, 21, 'No Aprobado', 'No Aprobado');
...
(13, 'Administrador', 'Administrador', 'Administrador', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-10', NULL, 'A', 'A', 'admin@admin.com', NULL, 3),
...
(32, 'Operario', 'Operario', 'Operario', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-17', NULL, 'O', 'A', 'uva1s@beta.com', NULL, 1),
