...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-01-2024 a las 19:57:31
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_fundo_registro` (IN `_idcategoria` INT, IN `_nombrefundo` TEXT)   BEGIN
    INSERT INTO fundo(jefe_fundo, nombre) VALUES (_idcategoria, _nombrefundo);
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_motivvo_aplicacion_listar` ()   SELECT * from motivo_aplicacion 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_usuarios_getdata` (IN `_idusuario` INT)   BEGIN
	SELECT idusuario, nombres, apellidos, nombreusuario, clave, fechacreacion, fechabaja, 
		CASE 
			...
			WHEN nivelacceso = "S" THEN "Jefe de Fundo"
...
(13, 'Administrador', 'Administrador', 'Administrador', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-10', NULL, 'A', 'A', 'admin@admin.com', NULL, 13),
(16, 'Amadeo', 'Acuña', 'aacuña', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(17, 'Roberto', 'Bernales', 'rbernales', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(18, 'Roque', 'Sifuentes', 'rsifuentes', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(19, 'Silverio', 'Ccoyori', 'sccoyori', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(20, 'Gary', 'Trujillo', 'gtrujillo', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(21, 'Miguel', 'Deunis', 'mdeunis', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(22, 'Fernando', 'Cabrera', 'fcabrera', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(23, 'Javier', 'Medina', 'jmedina', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(24, 'Rony', 'Laura', 'rlaura', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(25, 'Karina', 'Torres', 'ktorres', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(26, 'Eder', 'Razabal', 'erazabal', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(27, 'Ricardo', 'Velarde', 'rvelarde', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(28, 'Miguel', 'Vallardares', 'mvallardares', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0),
(29, 'Gino', 'Rosas', 'grosas', '$2y$10$dvgzm2Jmh0u98DerZSGkX.QH5rVqqD/ctSC3UCgYNj4jFh0CgR5mi', '2024-01-16', NULL, 'S', 'A', 'uva1s@beta.com', NULL, 0);
...
--
ALTER TABLE `fundo`
  MODIFY `id_fundo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `productos`
  MODIFY `idproducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=506;
